...
FIRE_KERNEL_6_6_SCATTER_SOURCE_ABS := $(if $(FIRE_KERNEL_6_6_SCATTER_SOURCE),$(abspath $(FIRE_KERNEL_6_6_SCATTER_SOURCE)))
FIRE_KERNEL_6_6_SCATTER_OUTPUT_ABS := $(if $(FIRE_KERNEL_6_6_SCATTER_OUTPUT),$(abspath $(FIRE_KERNEL_6_6_SCATTER_OUTPUT)))
...
$(FIRE_KERNEL_6_6_STAMP): FORCE
	...
	$(hide) if [ -n "$(FIRE_KERNEL_6_6_SCATTER_SOURCE_ABS)" ]; then \
		python3 $(abspath $(LOCAL_PATH)/kernel/6.6/check-fire-gki66-partitions.py) \
			--output "$(FIRE_KERNEL_6_6_SCATTER_OUTPUT_ABS)" \
			"$(FIRE_KERNEL_6_6_SCATTER_SOURCE_ABS)"; \
	fi
	$(hide) touch $@
