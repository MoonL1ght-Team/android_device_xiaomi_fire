...
# Stock HOS2 boot payload
FIRE_HOS2_PREBUILT_DIR := vendor/xiaomi/fire/prebuilt/hos2
BOARD_PREBUILT_VENDOR_BOOTIMAGE := $(FIRE_HOS2_PREBUILT_DIR)/vendor_boot.img
BOARD_PREBUILT_DTBOIMAGE := $(FIRE_HOS2_PREBUILT_DIR)/dtbo.img
BOARD_PREBUILT_VENDORIMAGE := $(FIRE_HOS2_PREBUILT_DIR)/vendor.img
BOARD_PREBUILT_VENDOR_DLKMIMAGE := $(FIRE_HOS2_PREBUILT_DIR)/vendor_dlkm.img
BOARD_PREBUILT_SYSTEM_DLKMIMAGE := $(FIRE_HOS2_PREBUILT_DIR)/system_dlkm.img
BOARD_PREBUILT_ODM_DLKMIMAGE := $(FIRE_HOS2_PREBUILT_DIR)/odm_dlkm.img
