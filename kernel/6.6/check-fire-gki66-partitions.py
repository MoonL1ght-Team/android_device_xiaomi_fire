...
EXPECTED = {
    "boot_a": 0x8000000,
    "boot_b": 0x8000000,
    "vendor_boot_a": 0x4000000,
    "vendor_boot_b": 0x4000000,
    "dtbo_a": 0x800000,
    "dtbo_b": 0x800000,
}
...
def main():
    ...
    parser.add_argument(
        ...
        "--output",
        type=Path,
        help="copy the validated stock-layout scatter to this path",
    )
    ...
    print("Fire GKI 6.6 stock partition contract looks coherent")

    if args.output:
        args.output.parent.mkdir(parents=True, exist_ok=True)
        args.output.write_bytes(args.scatter.read_bytes())
        print(f"Copied validated stock scatter to {args.output}")
